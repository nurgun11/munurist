  ...
  <div class="s-breadcrumbs">
      <div class="container">
        <ul>
          ...
          <li>/</li>
          <li>
            <a href="/courses"> Курсы повышения квалификации </a>
          </li>
          <li>/</li>
          <li>
            <a href="#">
    ...
    <div class="s-single-course">
      <div class="container">
        ...
        <div class="courses-item">
          ...
          <div class="courses-image">
           ...
           <div class="courses-subitem">
             <a href="/kontakty" class="courses-button">Записаться на курс</a>
           </div>
        ...
        <div class="single-content">
          <?php $courses_fields = CFS()->get( 'course-descr' );
              foreach ( $courses_fields as $field ) : ?>                
              <!-- echo $field['upload']; -->
                <div class="course-text">
                  <h3>
                    <?php echo $field['course-descr-title']; ?>
                  </h3>
                </div>
                <div class="courses-list-wrap">
                  <?php echo $field['course-descr-content']?>
                </div>               
              <?php endforeach;?>     
        </div>
      </div>
