  ...
  <div class="s-breadcrumbs">
      <div class="container">
        <ul>
          ...
          <li>/</li>
          <li>
            <a href="/programms"> Программы профессиональной переподготовки </a>
          </li>
          <li>/</li>
          <li>
            <a href="#">
    ...
    <div class="s-single-course">
      <div class="container">
        ...
        <div class="courses-item">
          ...
          <?php the_post_thumbnail('medium')?>
            ...
            <div class="courses-subitem">
                <a href="/kontakty" class="courses-button">Записаться на обучение</a>
            </div>
          </div>
        ...
        <div class="single-content">
          <?php $programms_fields = CFS()->get( 'programm-descr' );
              foreach ( $programms_fields as $field ) : ?>                
              <!-- echo $field['upload']; -->
                <div class="course-text">
                  <h3>
                    <?php echo $field['programm-descr-title']; ?>
                  </h3>
                </div>
                <div class="courses-list-wrap">
                  <?php echo $field['programm-descr-content']?>
                </div>               
              <?php endforeach;?>             
        </div>
      </div>
